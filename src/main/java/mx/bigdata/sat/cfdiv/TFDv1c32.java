...
public final class TFDv1c32 {
  ...
  public TFDv1c32(CFDI cfd, TimbreFiscalDigital tfd) throws Exception{
      this.document = cfd.getComprobante();
      this.cert = null;
      this.tfd = tfd;
  }
  
  public TFDv1c32(CFDI cfd, X509Certificate cert, UUID uuid, Date date)
    throws Exception {
    this.cert = cert;
    this.document = cfd.getComprobante();
